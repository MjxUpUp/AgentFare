...
export const BUILTIN_MODELS: ModelEntry[] = [
  // === OpenAI ===
  {
    ...
    displayName: "GPT-5.5",
    tier: "powerful",
    pricing: { inputPerMillion: 5, outputPerMillion: 30, cacheHitPerMillion: null, currency: "USD" },
  ...
  },
  {
    ...
    displayName: "GPT-5.4",
    tier: "standard",
    pricing: { inputPerMillion: 2.50, outputPerMillion: 15, cacheHitPerMillion: null, currency: "USD" },
  ...
  // ISSUE-056: gpt-5.3-codex-spark is a ChatGPT research preview; standard API uses gpt-5.3-codex
  {
    id: "openai/gpt-5.3-codex-spark",
    provider: "openai",
    displayName: "GPT-5.3 Codex Spark",
    tier: "fast",
    pricing: { inputPerMillion: 3.50, outputPerMillion: 0.35, cacheHitPerMillion: null, currency: "USD" },
    ...
    api: { protocol: "openai", baseUrl: "https://api.openai.com/v1", modelId: "gpt-5.3-codex" },
  },
  {
    ...
    tier: "fast",
    pricing: { inputPerMillion: 0.75, outputPerMillion: 4.50, cacheHitPerMillion: 0.075, currency: "USD" },
  ...
  // === Google ===
  {
    ...
    tier: "powerful",
    pricing: { inputPerMillion: 1.25, outputPerMillion: 10, cacheHitPerMillion: null, currency: "USD" },
  ...
  },
  {
    ...
    tier: "fast",
    pricing: { inputPerMillion: 0.30, outputPerMillion: 2.50, cacheHitPerMillion: null, currency: "USD" },
  ...
  // === 智谱 ===
  {
    ...
    displayName: "GLM-5",
    tier: "powerful",
    pricing: { inputPerMillion: 1.0, outputPerMillion: 3.2, cacheHitPerMillion: null, currency: "USD" },
  ...
  // === 月之暗面 ===
  {
    ...
    tier: "standard",
    pricing: { inputPerMillion: 0.95, outputPerMillion: 4.00, cacheHitPerMillion: 0.15, currency: "USD" },
  ...
  // === 阿里 ===
  {
    ...
    tier: "standard",
    pricing: { inputPerMillion: 1.67, outputPerMillion: 5.00, cacheHitPerMillion: 0.42, currency: "USD" },
